<?php
/*------------ I Used This To Extract The Data Of Candidates whose roll no was in range 1001001-1100000--------------*/
			...
			if(strpos($page,'not qualified in JEE (Advan')!==false)
			...
			else
				{
					...
					if(strpos($page,'Your Rank in the')!==false)
						{
							...
							$query="INSERT INTO result1 VALUES ('$i', '$name', NULL, '$cat', '$catrank')";
							mysqli_query($db,$query);
							}
						}
					else
					{
						...
						$query="INSERT INTO result1 VALUES ('$i', '$name', '$air', 'GEN', NULL)";
						mysqli_query($db,$query);
					}
				}	
		}

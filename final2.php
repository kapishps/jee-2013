			...
			if(strpos($page,'not qualified in JEE (Advan')!==false)
			...
			else
				{
					...
					if(strpos($page,'Your Rank in the')!==false)
						{
							...
							$query="INSERT INTO result2 VALUES ('$i', '$name', '$air', '$cat', '$catrank')";
							mysqli_query($db,$query);
							}
							else
							{
							echo "$name---$i---AIR---$air---$cat--rank---$catrank-- <br>";
							$query="INSERT INTO result2 VALUES ('$i', '$name', NULL, '$cat', '$catrank')";
							mysqli_query($db,$query);
							}
						}
					else
					{
						...
						$query="INSERT INTO result2 VALUES ('$i', '$name', '$air', 'GEN', NULL)";
						mysqli_query($db,$query);
					}
				}	
		}
